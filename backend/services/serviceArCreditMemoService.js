...
const getReferenceData = async () => loadDocumentCurrencyReferenceData(
  {},
  await serviceArCreditMemoDb.getReferenceData(),
);
...
module.exports = {
  ...
  getServiceARCreditMemo: async (...args) => normalizeCopyDocumentRate(
    await serviceArCreditMemoDb.getServiceARCreditMemo(...args),
  ...
  getServiceARInvoiceForCopy: async (...args) => normalizeCopyDocumentRate(
    await serviceArCreditMemoDb.getServiceARInvoiceForCopy(...args),
    await loadDocumentCurrencyReferenceData(),
  ),
};
