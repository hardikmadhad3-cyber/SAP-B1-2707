...
export const SALES_QUOTATION_WORKBOOK_COLUMNS = withOrder([
  ...
  { key: 'taxCodeRepeat', label: 'TaxCode', minWidth: 110, valueKey: 'U_TAXCODE', rendererKey: 'taxCodeRepeat', isUdf: true },
...
export const AR_INVOICE_WORKBOOK_COLUMNS = withOrder([
  ...
  { key: 'priceAfterDiscount', label: 'Price after Disc.', minWidth: 130, readOnly: true, numeric: true },
  ...
  { key: 'glAccount', label: 'G/L Account', minWidth: 135, visible: false },
  { key: 'glAccountName', label: 'G/L Account Name', minWidth: 190, readOnly: true, visible: false },
]);
...
export const AR_CREDIT_MEMO_WORKBOOK_COLUMNS = withOrder([
  ...
  { key: 'hsnCode', label: 'HSN', minWidth: 115 },
  { key: 'sacCode', label: 'SAC', minWidth: 95 },
  { key: 'costSheet', label: 'Cost-Sheet', minWidth: 125 },
  { key: 'packingType', label: 'Packing-Type', minWidth: 135 },
  { key: 'containerType', label: 'Container Type', minWidth: 135 },
  { key: 'grossWt', label: 'GrossWt', minWidth: 110, numeric: true },
  { key: 'totalPackage', label: 'Total-Package', minWidth: 130, numeric: true },
  { key: 'taxCodeRepeat', label: 'TaxCode', minWidth: 110, readOnly: true },
  { key: 'price', label: 'Price', minWidth: 95, numeric: true },
  { key: 'sellerBrokerage', label: 'Seller Brokerage', minWidth: 135 },
  { key: 'buyerBrokerage', label: 'Buyer Brokerage', minWidth: 130 },
  { key: 'buyerDelivery', label: 'Buyer - Delivery', minWidth: 135 },
  ...
  { key: 'commission', label: 'Commision', minWidth: 110 },
  { key: 'sellerBrokeragePerQty', label: 'BrokPerQty', minWidth: 110 },
  { key: 'fixBrokBuyer', label: 'FIX Brok BUYER', minWidth: 135, numeric: true },
  { key: 'fixBrockSeller', label: 'Fix Brock Seller', minWidth: 140, numeric: true },
  { key: 'sellerPaymentTermsRepeat', label: 'Seller - Terms of Payment', minWidth: 180 },
]);
