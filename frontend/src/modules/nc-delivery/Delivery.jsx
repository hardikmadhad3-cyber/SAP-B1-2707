...
function NCDelivery() {
    ...
    const load = async () => {
      ...
      try {
        ...
        const firstLineWarehouse = loadedLines.length > 0
          ...
          : '';
        console.log('ðŸ“¦ [NC Delivery] Loaded delivery data:', so);
        console.log('ðŸ“¦ [NC Delivery] Header:', so.header);
        console.log('ðŸ“¦ [NC Delivery] Lines:', so.lines);
        ...
        console.log('ðŸ“¦ [NC Delivery] Lines after mapping:', lines);
  ...
  const handleHeaderChange = (e) => {
    ...
    console.log('ðŸ”§ [NC Delivery] handleHeaderChange called:', { name, value, type });
    ...
    if (name === 'branch') {
      console.log('ðŸ¢ [NC Delivery] Branch changing to:', value);
  ...
  const addLine = () => {
    ...
    console.log('âž• [NC Delivery] Adding new line with header values:', {
  ...
  useEffect(() => {
    ...
    console.log('ðŸ”„ [NC Delivery] Branch sync useEffect triggered');
    console.log('ðŸ”„ [NC Delivery] header.branch value:', header.branch);
    console.log('ðŸ”„ [NC Delivery] header.branch type:', typeof header.branch);
    console.log('ðŸ”„ [NC Delivery] Current lines count:', lines.length);
    
    if (header.branch) {
      console.log('ðŸ”„ [NC Delivery] Syncing branch to all lines:', header.branch);
      setLines(prev => {
        console.log('ðŸ”„ [NC Delivery] Previous lines:', prev.map(l => ({ itemNo: l.itemNo, branch: l.branch, loc: l.loc })));
        const updated = prev.map(l => ({ 
          ...l, 
          branch: String(header.branch), 
          loc: String(header.branch)
        }));
        console.log('âœ… [NC Delivery] Updated lines:', updated.map(l => ({ itemNo: l.itemNo, branch: l.branch, loc: l.loc })));
        return updated;
      });
    } else {
      console.log('âš ï¸ [NC Delivery] Branch is empty, skipping sync');
    }
  }, [header.branch]);
  ...
  useEffect(() => {
    ...
    if (header.branch && lines.length > 0) {
      ...
      if (needsSync) {
        console.log('ðŸ”„ [NC Delivery] Initial branch sync needed');
  ...
  useEffect(() => {
    console.log('ðŸ“ [NC Delivery] Lines state changed:', lines.map(l => ({ itemNo: l.itemNo, branch: l.branch, loc: l.loc, whse: l.whse })));
  }, [lines]);
